...
<script src="${ctx.path}/resources/components/datePicker/WdatePicker.js"></script>

<!-- 基本方法js -->
<script src="${ctx.path}/resources/js/common/common.js"></script>   
 
<%-- <link rel="stylesheet" href="${ctx.path}/resources/css/all.css?v=${ctx.versions}" rel="stylesheet">
<script src="${ctx.path}/resources/script/total/all.js?v=${ctx.versions}"></script>  
<script src="${ctx.path}/resources/components/hplus/plugins/layer/layer.min.js"></script>
<script src="${ctx.path}/resources/components/hplus/plugins/layer/extend/layer.ext.js"></script>
<script src="${ctx.path}/resources/components/datePicker/WdatePicker.js"></script> --%>
