...
(function () {
    ...
    Popup.prototype = {
        ...
        fitSize: function (){
            ...
            this.__size = size;
            this.captureWheel && (this.getDom('content').style.overflow = 'auto')&&(this.getDom('content').style.maxHeight = '160px');
            return size;
        },
...
(function () {
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'insertframe', 'edittip', 'edittable', 'edittd', 'scrawl', 'template', 'music', 'background', 'docfield','flowno']
