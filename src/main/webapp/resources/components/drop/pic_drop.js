...
$.fn.sortable = function(options) {
	/**让li随子元素大小改变大小**/
	var liheight = (parseInt($(this).find('li').children().css('height'))+2)+'px',
		liwidth = (parseInt($(this).find('li').children().css('width'))+2)+'px',
		placeholderHeight = (parseInt(liheight))+'px',
		placeholderWidth = (parseInt(liwidth))+'px';
	$(this).find('li').height(liheight).width(liwidth).css('border','1px solid none;');
	/** end**/
	options = options || {};
