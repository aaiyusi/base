...
<head>
    ...
    <script src="${ctx.path}/resources/script/logistics/logisticsOwnCompany.js"></script>
    <!-- 图片选择 -->
			...
			<div class="scroll-hide">
				<div class="publish-tab">
					<ul class="nav nav-tabs" id="grenul">
						...
						<li labelname="manualOWN" class="active"><a href="javascript:void(0);"
							class="pl5 pr5"><span class="text">自定义物流</span></a></li>
					<!-- 	<li labelname="manualSYS"   ><a
    ...
    <div id="buttonDiv" class="row wrapper ">
            <div class="form-inline operation_con">
                <div class="large-list-title">
                    <button class="btn btn-success btn-sm" type="button" onclick="openAddPage();">新增自定义物流</button>
                </div>
            </div>
    </div>
...
<div id="dataAdd" class="white-bg " style="display:none;">
	...
	<div class="ibox">
		...
		<div class="form-group nm">
			...
			<div class="col-sm-4">
				<i class="tips-info fa fa-question-circle fr" data-title="屏蔽跟踪号" data-container="body" data-content="如果您仅想去eBay上标注订单发货，而不同步跟踪单号，请勾选。注：速卖通/亚马逊订单必须上传跟踪号" data-placement="top" data-trigger="hover" data-toggle="popover" data-original-title="" title=""></i>
		...
		<div class="form-group nm">
			...
			<div class="col-sm-4 has-tips"> 
				...
				<i class="tips-info fa fa-question-circle" data-title="规则适用范围" data-container="body" data-content="适合京沪粤苏浙闽黑的邮政平邮运费算法" data-placement="top" data-trigger="hover" data-toggle="popover" data-original-title="" title=""></i>
			</div>
			<label class="col-sm-2 control-label">折扣</label>
			<div class="col-sm-2 has-tips ">
				   <input type="text" class="form-control inputgroup60 input-sm" disabled="" id="discount" name="discount" value="1">
				   <i class="tips-info fa fa-question-circle" data-title="折扣" data-container="body" data-content="例：0.75表示七五折" data-placement="top" data-trigger="hover" data-toggle="popover" data-original-title="" title=""></i>
			</div>
		</div>
		</div>
	</div>
	<div class="ibox">
		...
		<div class="form-group nm">
			...
			<div class="col-sm-2 has-tips">
				...
				<i class="tips-info fa fa-question-circle" data-title="申报价值占比" data-container="body" data-content="申报价值占订单商品总售价的百分比" data-placement="top" data-trigger="hover" data-toggle="popover" data-original-title="" title=""></i>
			</div>
	...
	<div class="ibox">
		...
		<div class="form-group nm">
			...
			<div class="col-sm-5">
				...
				<erp:dictTag className="form-control" name="labelSize" id="labelAddSize" style="width:200px" dictTypeId="2" />	
			</div>
	...
	<div class="ibox">
		<div class="ibox-title">
            <h5>回邮地址<span class="fsize12 pl7 thin" style="color:red">(线上发货必须用英文填写)</span></h5>
            <div class="ibox-tools">
					<select class="form-control" id="addressSelect"
								name="backAddressId"></select>
		  </div>
		</div>
		<div class="ibox-content">
		<div id="default-address1" data-id="3188">
			...
			<div class="form-group nm">
				...
				<div class="col-sm-4"><p class="loadtext-sm" id="addressNameAdd"></p></div>
...
<div id="dataEdit" class="white-bg " style="display:none;">
	...
	<div class="ibox">
		...
		<div class="form-group nm">
			...
			<div class="col-sm-5">
				<p class="loadtext fl bold text-default pr5"><span class="text-danger pr5">*</span>标签尺寸</p>
				<erp:dictTag className="form-control" name="labelSize" id="labelEditSize" style="width:200px" dictTypeId="2"/>	
			</div>
			<div class="col-md-2 text-right">
				<a href="javascript:void(0);" onclick="openModuleManager()" target="_blank">标签模板管理</a>
			</div>
