...
<script src="${ctx.path}/resources/script/whouse/whouseIn.js"></script>
			...
			<div class="scroll-hide">
				<div class="publish-tab">
					<ul class="nav nav-tabs" id="grenul">
						<li labelname="manualOut"><a href="javascript:void(0);"
							class="pl5 pr5"><span class="text">手工出库</span></a></li>
						<li labelname="manualIn" class="active"><a
					...
					<form id="pageForm" method="post">
						<div class="form-inline">
							<div class="form-group">
									...
									<!-- <select class="form-control" name="mohu" id="mohuSelect">
										<option value="">模糊查询条件</option>
										<option value="sku">按库存SKU编号</option>
										<option value="storageCode">按批次号</option>
										<option value="spaceId">按仓位</option>
									</select>
									<input id="mohuInput" placeholder="请输入关键字" class="form-control layer-date input-small" readonly="readonly"/> -->
							</div>
				...
				<div class="form-inline operation_con">
					<div class="large-list-title">
						<button class="btn btn-success btn-sm" type="button"
							onclick="openAddPage();">新增入库批次</button>
					</div>
			</div>
		</div>
	...
	<div id="dataAdd" class="white-bg"
		...
		<form class="form-horizontal"
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">
						基本信息&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">不同入库日期或者不同仓库的请分批提交入库</font>
					</h3>
				</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="remark" id="remark"
								maxlength="200" rows="1" type="textarea" 
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">
						入库商品清单&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">批量导入前请先在上方选择入库日期和仓库</font>
					</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-sm-2 control-label"><font color="red">*</font>添加入库商品</label>
						<div class="col-sm-2">
							<input type="text" name="InSKU" class="form-control"id="InSKU"
								maxlength="10" placeholder="入库存SKU(必填)" required
								data-msg-required="请输入库存SKU！"><label id="InSKUCheck" style="color:red"></label>
						</div>
						<div class="col-sm-2">
							<input type="text" name="InCount" class="form-control" id="InCount"
								maxlength="10" placeholder="入库数量(必填)" required
								data-msg-required="请输入入库数量！"><label id="InCountCheck" style="color:red"></label>
						</div>
						<div class="col-sm-2">
						...
						<div class="col-sm-2">
							<input type="text" name="price" class="form-control" id="price"
								maxlength="20" placeholder="单价(非必填)" 
								>
						</div>
		...
		<form class="form-horizontal"
			...
			<div class="panel panel-default">
				<div class="panel-heading">
							...
							<a class="btn btn-warning"  id="printInList" target="_blank"   >打印入库清单</a>
							</div>
				</div>
				<div class="panel-body">
					<div class="row">
